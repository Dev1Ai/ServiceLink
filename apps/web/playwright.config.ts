...
process.env.E2E_API_BASE = process.env.E2E_API_BASE ?? `http://127.0.0.1:${process.env.E2E_API_PORT}`;
  ...
  webServer: [
    {
      ...
      env: {
        ...
        DATABASE_URL: process.env.E2E_DATABASE_URL ?? process.env.DATABASE_URL ?? 'postgresql://postgres:postgres@localhost:5432/servicelink',
