  ...
  rules: {
    ...
    "no-restricted-syntax": [
      "error",
      {
        ...
        message:
          "Inline <style> must include nonce={nonce} from NonceContext when ENABLE_STRICT_CSP=true.",
      },
      {
        selector:
        ...
        message:
          "next/Script must include nonce={nonce} from NonceContext when ENABLE_STRICT_CSP=true.",
      },
    ],
  },
};
