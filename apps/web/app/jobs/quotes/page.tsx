...
function QuotesStaticContent() {
  ...
  return (
    <div className="container">
        ...
        <div className="mb-12 text-subtle">
            ...
            <div className="mt-6 font-13 text-green-strong">
              ...
              {job.assignment.customerVerifiedAt && (
                <span className="ml-8 text-blue-strong">
                  • Verified:{" "}
                  {new Date(job.assignment.customerVerifiedAt).toLocaleString()}
                </span>
              )}
            </div>
          )}
          {job.assignment && (
            <div className="mt-8 flex gap-8 items-center">
              <button onClick={verifyComplete}>
                Verify completion (customer)
              </button>
              {revokeStatus && (
      ...
      <div className="mt-8">
        <Link href={`/jobs/${encodeURIComponent(id)}/quotes`}>
          Go to dynamic quotes page
        </Link>
      </div>
    </div>
  );
