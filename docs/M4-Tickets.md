...
### T1: Expand Assignment Schema for Scheduling Fields _(Owner: Backend – Alex, Sprint: M4-S1)_
...
### T2: API Endpoints for Propose/Confirm/Reject Scheduling _(Owner: Backend – Priya, Sprint: M4-S1)_
...
### T3: Calendar Integration Service _(Owner: Platform – Wei, Sprint: M4-S2)_
...
### T4: Background Worker Foundation _(Owner: DevOps – Sam, Sprint: M4-S1)_
...
### T5: Reminder Job Implementation _(Owner: Backend – Alex, Sprint: M4-S2)_
...
### T6: NotificationsService Enhancements _(Owner: Backend – Priya, Sprint: M4-S2)_
...
### T7: Provider Rejection & Requeue Workflow _(Owner: Backend – Priya, Sprint: M4-S3)_
...
### T8: Admin UI for Manual Payout Approvals _(Owner: Web – Dana, Sprint: M4-S3)_
...
### T9: Fulfillment Metrics Dashboard _(Owner: Web – Miguel, Sprint: M4-S3)_
...
### T10: Alerting & Logging Enhancements _(Owner: DevOps – Sam, Sprint: M4-S2)_
...
### T11: Ops Runbook Updates _(Owner: Ops – Jamie, Sprint: M4-S3)_
...
### T12: ADR for Background Job Framework _(Owner: Platform – Wei, Sprint: M4-S1)_
...
### T13: API Test Coverage _(Owner: QA – Lina, Sprint: M4-S3)_
...
### T14: Playwright Scenarios _(Owner: QA – Lina, Sprint: M4-S3)_
